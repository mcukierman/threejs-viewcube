    ...
    Viewcube.prototype.setView = function (view) {
        ...
        switch (view) {
            case self.FACES.BACK:
                self.tweenViewRotationByYawPitch(Y_BACK, Y_FRONT);
                break;
            case self.FACES.BACK_LEFT_EDGE:
                self.tweenViewRotationByYawPitch( Y_BACK + HALF, P_CENTER );
                break;
            case self.FACES.BACK_RIGHT_EDGE:
                self.tweenViewRotationByYawPitch( Y_BACK - HALF, P_CENTER );
                break;
            case self.FACES.BOTTOM:
                self.tweenViewRotationByYawPitch( Y_FRONT, P_BOTTOM );
                break;
            case self.FACES.BOTTOM_BACK_EDGE:
                self.tweenViewRotationByYawPitch( Y_BACK, P_BOTTOM + HALF );
                break;
            case self.FACES.BOTTOM_BACK_LEFT_CORNER:
                self.tweenViewRotationByYawPitch( Y_BACK + HALF, P_BOTTOM + HALF );
                break;
            case self.FACES.BOTTOM_BACK_RIGHT_CORNER:
                self.tweenViewRotationByYawPitch( Y_BACK - HALF, P_BOTTOM + HALF );
                break;
            case self.FACES.BOTTOM_FRONT_EDGE:
                self.tweenViewRotationByYawPitch( Y_FRONT, P_BOTTOM + HALF);
                break;
            case self.FACES.BOTTOM_FRONT_LEFT_CORNER:
                self.tweenViewRotationByYawPitch( Y_FRONT - HALF, P_BOTTOM + HALF);
                break;
            case self.FACES.BOTTOM_FRONT_RIGHT_CORNER:
                self.tweenViewRotationByYawPitch( Y_FRONT + HALF, P_BOTTOM + HALF);
                break;
            case self.FACES.BOTTOM_LEFT_EDGE:
                self.tweenViewRotationByYawPitch( Y_LEFT, P_BOTTOM + HALF);
                break;
            case self.FACES.BOTTOM_RIGHT_EDGE:
                self.tweenViewRotationByYawPitch( Y_RIGHT, P_BOTTOM + HALF);
                break;
            case self.FACES.FRONT:
                self.tweenViewRotationByYawPitch( Y_FRONT, P_CENTER );
                break;
            case self.FACES.FRONT_LEFT_EDGE:
                self.tweenViewRotationByYawPitch( Y_FRONT - HALF, P_CENTER);
                break;
            case self.FACES.FRONT_RIGHT_EDGE:
                self.tweenViewRotationByYawPitch( Y_FRONT + HALF, P_CENTER);
                break;
            case self.FACES.LEFT:
                self.tweenViewRotationByYawPitch( Y_LEFT, P_CENTER);
                break;
            case self.FACES.RIGHT:
                self.tweenViewRotationByYawPitch( Y_RIGHT, P_CENTER);
                break;
            case self.FACES.TOP:
                self.tweenViewRotationByYawPitch( Y_FRONT, P_TOP );
                break;
            case self.FACES.TOP_BACK_EDGE:
                self.tweenViewRotationByYawPitch( Y_BACK, P_TOP - HALF );
                break;
            case self.FACES.TOP_BACK_LEFT_CORNER:
                self.tweenViewRotationByYawPitch( Y_BACK + HALF, P_TOP - HALF );
                break;
            case self.FACES.TOP_BACK_RIGHT_CORNER:
                self.tweenViewRotationByYawPitch( Y_BACK - HALF, P_TOP - HALF );
                break;
            case self.FACES.TOP_FRONT_EDGE:
                self.tweenViewRotationByYawPitch(Y_FRONT, P_TOP - HALF);
                break;
            case self.FACES.TOP_FRONT_LEFT_CORNER:
                self.tweenViewRotationByYawPitch( Y_FRONT - HALF, P_TOP - HALF );
                break;
            case self.FACES.TOP_FRONT_RIGHT_CORNER:
                self.tweenViewRotationByYawPitch( Y_FRONT + HALF, P_TOP - HALF );
                break;
            case self.FACES.TOP_LEFT_EDGE:
                self.tweenViewRotationByYawPitch(Y_LEFT, P_TOP - HALF);
                break;
            case self.FACES.TOP_RIGHT_EDGE:
                self.tweenViewRotationByYawPitch(Y_RIGHT, P_TOP - HALF);
                break;
            default:
        ...
        return new Promise(function (resolve) {
            ...
            tween.onUpdate(function () {
                ...
                self.dispatchEvent({
                    type: FOUR.EVENT.UPDATE,
                    view: self.view,
                    direction: self.view.quaternion
                });
